...
> **先读：[最终综合](00-final-synthesis.md)。** 它统一术语、核心结论、阅读路线、证据边界和停止条件；`01-08` 是按主题展开的源码证据层。
...
研究日期：2026-07-16。结论基于固定提交的源码、测试、官方文档和 GitHub 公开元数据；没有启动应用、读取真实凭证、运行真实 provider 或做真机验收。
...
只想快速形成直觉时，只读最终综合和案例卡。想真正理解“点击切换后发生什么”，再读第 2、3、5 章；想研究 gateway，再读第 6、7 章。
