...
| `amplification-hell-2014` | [Amplification Hell 2014 — 把家用宽带放大成几百 Gbps 的反射攻击](/study/papers/amplification-hell-2014/) |
...
| `andromeda-2018` | [Andromeda — Google Cloud 网络虚拟化的高速通道](/study/papers/andromeda-2018/) |
...
| `bigtable` | [Bigtable — 把巨大表格切到上千台机器上](/study/papers/bigtable/) |
...
| `cerf-kahn-1974` | [Cerf-Kahn 1974 — 用网关把异构网络拼成一个互联网](/study/papers/cerf-kahn-1974/) |
...
| `compose-future-theorems` | [COMPOSE — 用引用图和 Mathlib 图预测未来定理](/study/papers/compose-future-theorems/) |
...
| `contriever-2021` | [Contriever — 不用人工标注也能训练稠密检索器](/study/papers/contriever-2021/) |
| `controlled-channel-attacks-2015` | [Controlled-Channel Attacks 2015 — 不可信操作系统也能用缺页记录偷看程序](/study/papers/controlled-channel-attacks-2015/) |
...
| `cousot-halbwachs-polyhedra-1978` | [Cousot-Halbwachs 凸多面体域 — 让分析器自己发现变量间的线性关系](/study/papers/cousot-halbwachs-polyhedra-1978/) |
...
| `dremel-2010` | [Dremel 2010 — BigQuery 和 Parquet 背后的嵌套列式分析](/study/papers/dremel-2010/) |
| `dremel-decade-2020` | [Dremel 十年回顾 — BigQuery 背后的交互式云数仓路线](/study/papers/dremel-decade-2020/) |
| `driller-2016` | [Driller 2016 — 用符号执行给 fuzzing 打穿深分支](/study/papers/driller-2016/) |
...
| `foreshadow-2018` | [Foreshadow 2018 — SGX 保险箱也挡不住瞬态执行脚印](/study/papers/foreshadow-2018/) |
...
| `freedman-psi-2004` | [Freedman PSI 2004 — 把集合交集算出来但不交出名单](/study/papers/freedman-psi-2004/) |
| `frenetic-2011` | [Frenetic 2011 — 把 OpenFlow 流表换成函数式程序](/study/papers/frenetic-2011/) |
...
| `gemini-1.5-2024` | [Gemini 1.5 — 百万 token 多模态上下文的工程样板](/study/papers/gemini-1.5-2024/) |
...
| `instant-ngp-2022` | [Instant-NGP — 秒级训练 NeRF 的多分辨率哈希编码](/study/papers/instant-ngp-2022/) |
...
| `knuth-literate-1984` | [Literate Programming — 把程序写成给人读的文章](/study/papers/knuth-literate-1984/) |
...
| `lamport-bakery` | [Lamport Bakery — 用取号排队解决并发互斥](/study/papers/lamport-bakery/) |
...
| `lora` | [LoRA — 给冻结大模型贴低秩便签](/study/papers/lora/) |
...
| `michael-scott-queue` | [Michael-Scott Queue — 用 CAS 做高性能并发队列](/study/papers/michael-scott-queue/) |
...
| `milvus-2021` | [Milvus 2021：把向量搜索做成数据库](/study/papers/milvus-2021/) |
...
| `mvcc` | [MVCC — 让读写互不挡路的版本账本](/study/papers/mvcc/) |
...
| `nestedkv` | [NestedKV: Nested Memory Routing for Long-Context KV Cache Compression — 学习笔记](/study/papers/nestedkv/) |
| `netflix-bellkor-2009` | [BellKor Netflix Prize 2009 — 集成学习赢下 100 万美金的工程实录](/study/papers/netflix-bellkor-2009/) |
| `netkat-2014` | [NetKAT 2014 — 把网络转发写成可以做数学等式变换的代数式](/study/papers/netkat-2014/) |
...
| `pointnet` | [PointNet — 直接吃点云的 3D 神经网络](/study/papers/pointnet/) |
...
| `quantum-supremacy-2019` | [Quantum Supremacy 2019 — 量子机用 200 秒做完超算 1 万年的事](/study/papers/quantum-supremacy-2019/) |
...
| `reward-hacking` | [Concrete Problems in AI Safety — 把 AI 安全风险拆成工程问题](/study/papers/reward-hacking/) |
...
| `salsify-2018` | [Salsify — 让编码器和传输层一起商量怎么发视频](/study/papers/salsify-2018/) |
...
| `self-trained-verification` | [Self-Trained Verification — 让模型先看标准答案学会挑错](/study/papers/self-trained-verification/) |
| `selinux-2001` | [SELinux — 给 Linux 装上不可绕过的安检门](/study/papers/selinux-2001/) |
...
| `shor-1994` | [Shor 1994 — 量子傅里叶变换把分解整数变成找周期](/study/papers/shor-1994/) |
| `silo-oltp-2013` | [Silo: Speedy Transactions in Multicore In-Memory Databases](/study/papers/silo-oltp-2013/) |
...
| `tcp-vegas-1995` | [TCP Vegas 1995 — 不等丢包，靠 RTT 早一步看见拥塞](/study/papers/tcp-vegas-1995/) |
| `td3-2018` | [TD3 — 给 DDPG 装两副刹车，连续控制终于稳了](/study/papers/td3-2018/) |
...
| `tfidf-classic` | [TF-IDF Classic — 给搜索词分清轻重缓急](/study/papers/tfidf-classic/) |
...
| `transformer-2017` | [Attention Is All You Need — 用 self-attention 重写序列建模](/study/papers/transformer-2017/) |
...
| `trustrank-2004` | [TrustRank — 用一小撮可信种子把整张 Web 的信誉算出来](/study/papers/trustrank-2004/) |
...
| `vall-e-2023` | [VALL-E — 3 秒音频样本就能克隆你的声音](/study/papers/vall-e-2023/) |
...
| `vega-lite` | [Vega-Lite — 用 JSON 三段式画复合图](/study/papers/vega-lite/) |
...
| `amplification-hell-2014` | [Amplification Hell 2014 — 把家用宽带放大成几百 Gbps 的反射攻击](/study/papers/amplification-hell-2014/) | 其他 |
...
| `andromeda-2018` | [Andromeda — Google Cloud 网络虚拟化的高速通道](/study/papers/andromeda-2018/) | 其他 |
...
| `bigtable` | [Bigtable — 把巨大表格切到上千台机器上](/study/papers/bigtable/) | 其他 |
...
| `calvin` | [Calvin — 先排队再执行的分布式事务系统](/study/papers/calvin/) | 其他 |
...
| `ccopd-distillation` | [CCOPD — 让多轮对话别被自己的旧话带偏](/study/papers/ccopd-distillation/) | 其他 |
...
| `cerf-kahn-1974` | [Cerf-Kahn 1974 — 用网关把异构网络拼成一个互联网](/study/papers/cerf-kahn-1974/) | 其他 |
...
| `compose-future-theorems` | [COMPOSE — 用引用图和 Mathlib 图预测未来定理](/study/papers/compose-future-theorems/) | 其他 |
...
| `contriever-2021` | [Contriever — 不用人工标注也能训练稠密检索器](/study/papers/contriever-2021/) | 其他 |
| `controlled-channel-attacks-2015` | [Controlled-Channel Attacks 2015 — 不可信操作系统也能用缺页记录偷看程序](/study/papers/controlled-channel-attacks-2015/) | 其他 |
...
| `cousot-halbwachs-polyhedra-1978` | [Cousot-Halbwachs 凸多面体域 — 让分析器自己发现变量间的线性关系](/study/papers/cousot-halbwachs-polyhedra-1978/) | 其他 |
...
| `delta-lake-2020` | [Delta Lake 2020 — 给对象存储补上事务日志](/study/papers/delta-lake-2020/) | 其他 |
...
| `dremel-2010` | [Dremel 2010 — BigQuery 和 Parquet 背后的嵌套列式分析](/study/papers/dremel-2010/) | 其他 |
| `dremel-decade-2020` | [Dremel 十年回顾 — BigQuery 背后的交互式云数仓路线](/study/papers/dremel-decade-2020/) | 其他 |
| `driller-2016` | [Driller 2016 — 用符号执行给 fuzzing 打穿深分支](/study/papers/driller-2016/) | 其他 |
...
| `dwork-dp-2006` | [Dwork DP 2006 — 用相邻数据集定义隐私](/study/papers/dwork-dp-2006/) | 其他 |
...
| `foreshadow-2018` | [Foreshadow 2018 — SGX 保险箱也挡不住瞬态执行脚印](/study/papers/foreshadow-2018/) | 其他 |
...
| `freedman-psi-2004` | [Freedman PSI 2004 — 把集合交集算出来但不交出名单](/study/papers/freedman-psi-2004/) | 其他 |
| `frenetic-2011` | [Frenetic 2011 — 把 OpenFlow 流表换成函数式程序](/study/papers/frenetic-2011/) | 其他 |
...
| `gemini-1.5-2024` | [Gemini 1.5 — 百万 token 多模态上下文的工程样板](/study/papers/gemini-1.5-2024/) | 其他 |
...
| `hits-1999` | [HITS — 给网页同时打两个分：权威页 + 索引页](/study/papers/hits-1999/) | 其他 |
...
| `instant-ngp-2022` | [Instant-NGP — 秒级训练 NeRF 的多分辨率哈希编码](/study/papers/instant-ngp-2022/) | 其他 |
...
| `kademlia-2002` | [Kademlia — 用 XOR 当距离的 P2P 路由表](/study/papers/kademlia-2002/) | 其他 |
...
| `knuth-literate-1984` | [Literate Programming — 把程序写成给人读的文章](/study/papers/knuth-literate-1984/) | 其他 |
...
| `kocher-spectre-2019` | [Spectre — CPU 猜错路时也会泄密](/study/papers/kocher-spectre-2019/) | 其他 |
...
| `lamport-bakery` | [Lamport Bakery — 用取号排队解决并发互斥](/study/papers/lamport-bakery/) | 其他 |
...
| `lora` | [LoRA — 给冻结大模型贴低秩便签](/study/papers/lora/) | 其他 |
...
| `maron-kuhns-1960` | [Maron-Kuhns 1960 — 检索不是匹配，是猜"对你有用的概率"](/study/papers/maron-kuhns-1960/) | 其他 |
...
| `michael-scott-queue` | [Michael-Scott Queue — 用 CAS 做高性能并发队列](/study/papers/michael-scott-queue/) | 其他 |
...
| `milvus-2021` | [Milvus 2021：把向量搜索做成数据库](/study/papers/milvus-2021/) | 其他 |
...
| `mvcc` | [MVCC — 让读写互不挡路的版本账本](/study/papers/mvcc/) | 其他 |
...
| `nestedkv` | [NestedKV: Nested Memory Routing for Long-Context KV Cache Compression — 学习笔记](/study/papers/nestedkv/) | 其他 |
| `netflix-bellkor-2009` | [BellKor Netflix Prize 2009 — 集成学习赢下 100 万美金的工程实录](/study/papers/netflix-bellkor-2009/) | 其他 |
| `netkat-2014` | [NetKAT 2014 — 把网络转发写成可以做数学等式变换的代数式](/study/papers/netkat-2014/) | 其他 |
...
| `openflow-2008` | [OpenFlow 2008 — 把交换机的『分拣规则』搬到一台中央电脑上](/study/papers/openflow-2008/) | 其他 |
...
| `pointnet` | [PointNet — 直接吃点云的 3D 神经网络](/study/papers/pointnet/) | 其他 |
...
| `prefix-cache-policy-2026` | [Beyond LRU: Prefix-Cache Policies for LLM Serving — 学习笔记（入门）](/study/papers/prefix-cache-policy-2026/) | 其他 |
...
| `pypy-tracing-jit` | [PyPy meta-tracing JIT — 给解释器加一次 JIT，所有用它的语言一起加速](/study/papers/pypy-tracing-jit/) | 其他 |
| `quantum-supremacy-2019` | [Quantum Supremacy 2019 — 量子机用 200 秒做完超算 1 万年的事](/study/papers/quantum-supremacy-2019/) | 其他 |
| `quic` | [QUIC — 把可靠传输从内核搬到用户空间](/study/papers/quic/) | 网络协议 |
| `quincy-2009` | [Quincy — 把"派活给机器"变成一道最小费用流题](/study/papers/quincy-2009/) | 其他 |
...
| `reward-hacking` | [Concrete Problems in AI Safety — 把 AI 安全风险拆成工程问题](/study/papers/reward-hacking/) | 其他 |
...
| `rm3-2001` | [RM3 — 让搜索引擎自己看一眼结果再重搜一次](/study/papers/rm3-2001/) | 其他 |
| `roberta-2019` | [RoBERTa — 把 BERT 重训一遍就能拿 SOTA](/study/papers/roberta-2019/) | 其他 |
...
| `salsify-2018` | [Salsify — 让编码器和传输层一起商量怎么发视频](/study/papers/salsify-2018/) | 其他 |
...
| `self-trained-verification` | [Self-Trained Verification — 让模型先看标准答案学会挑错](/study/papers/self-trained-verification/) | 其他 |
| `selinger-1979` | [Selinger 1979 — 基于代价的查询优化](/study/papers/selinger-1979/) | 数据库 |
| `selinux-2001` | [SELinux — 给 Linux 装上不可绕过的安检门](/study/papers/selinux-2001/) | 其他 |
...
| `shor-1994` | [Shor 1994 — 量子傅里叶变换把分解整数变成找周期](/study/papers/shor-1994/) | 其他 |
| `sillito-questions` | [Sillito 44 问题 — 程序员改代码时到底在问什么](/study/papers/sillito-questions/) | HCI / 软件工程研究 |
| `silo-oltp-2013` | [Silo: Speedy Transactions in Multicore In-Memory Databases](/study/papers/silo-oltp-2013/) | 其他 |
...
| `subramanian-2002-internet-hierarchy` | [Subramanian 2002 — 用多个观察点把互联网切成 5 层](/study/papers/subramanian-2002-internet-hierarchy/) | 其他 |
...
| `tcp-vegas-1995` | [TCP Vegas 1995 — 不等丢包，靠 RTT 早一步看见拥塞](/study/papers/tcp-vegas-1995/) | 其他 |
| `td3-2018` | [TD3 — 给 DDPG 装两副刹车，连续控制终于稳了](/study/papers/td3-2018/) | 其他 |
...
| `tfidf-classic` | [TF-IDF Classic — 给搜索词分清轻重缓急](/study/papers/tfidf-classic/) | 其他 |
...
| `transformer-2017` | [Attention Is All You Need — 用 self-attention 重写序列建模](/study/papers/transformer-2017/) | 其他 |
...
| `trustrank-2004` | [TrustRank — 用一小撮可信种子把整张 Web 的信誉算出来](/study/papers/trustrank-2004/) | 其他 |
...
| `vall-e-2023` | [VALL-E — 3 秒音频样本就能克隆你的声音](/study/papers/vall-e-2023/) | 其他 |
...
| `vega-lite` | [Vega-Lite — 用 JSON 三段式画复合图](/study/papers/vega-lite/) | 其他 |
