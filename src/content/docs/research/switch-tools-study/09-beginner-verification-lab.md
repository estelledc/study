---
title: "09. 零基础验证实验：看见控制面、投影和协议边界"
sidebar:
  hidden: true
---
...
```bash
git -C research-worktrees/csswitch status --short --branch
git -C research-worktrees/csswitch rev-parse HEAD

git -C research-worktrees/ccswitch status --short --branch
git -C research-worktrees/ccswitch rev-parse HEAD
```
...
```bash
cd research-worktrees/csswitch
...
```bash
cd research-worktrees/ccswitch
