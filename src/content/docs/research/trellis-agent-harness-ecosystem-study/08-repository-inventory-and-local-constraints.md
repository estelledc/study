...
|---|---|---|
| `trellis` | `estelledc/Trellis` | `research-worktrees/trellis` |
| `spec-kit` | `estelledc/spec-kit` | `research-worktrees/spec-kit` |
| `openspec` | `estelledc/OpenSpec` | `research-worktrees/openspec` |
| `bmad-method` | `estelledc/BMAD-METHOD` | `research-worktrees/bmad-method` |
| `superpowers` | `estelledc/superpowers` | `research-worktrees/superpowers` |
| `planning-with-files` | `estelledc/planning-with-files` | `research-worktrees/planning-with-files` |
| `gsd-core` | `estelledc/gsd-core` | `research-worktrees/gsd-core` |
| `agent-os` | `estelledc/agent-os` | `research-worktrees/agent-os` |
| `spec-workflow-mcp` | `estelledc/spec-workflow-mcp` | `research-worktrees/spec-workflow-mcp` |
| `compound-engineering` | `estelledc/compound-engineering-plugin` | `research-worktrees/compound-engineering` |
| `prps-agentic-eng` | `estelledc/PRPs-agentic-eng` | `research-worktrees/prps-agentic-eng` |
| `context-engineering-intro` | `estelledc/context-engineering-intro` | `research-worktrees/context-engineering-intro` |
| `acontext` | `estelledc/Acontext` | `research-worktrees/acontext` |
| `memu` | `estelledc/memU` | `research-worktrees/memu` |
| `claude-mem` | `estelledc/claude-mem` | `research-worktrees/claude-mem` |
| `spexcode` | `estelledc/Spexcode` | `research-worktrees/spexcode` |
| `openlore` | `estelledc/OpenLore` | `research-worktrees/openlore` |

## 4. 本地 clone 约束

### 4.1 为什么放在 `research-worktrees/`
...
git clone \
  ...
  research-worktrees/openspec

git -C research-worktrees/openspec \
...
```bash
git check-ignore -v research-worktrees/<slug>
git status --short
```
