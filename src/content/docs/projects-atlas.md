...
| 项目 | 描述 |
|---|---|
| [anime.js — 一行 JS 让网页元素按时间线动起来](/study/projects/anime/) |  |
...
| [MobX — 让 state 像电子表格一样自动重算](/study/projects/mobx/) |  |
...
| [ProseMirror — schema 先定 DOM 后服从的富文本编辑器框架](/study/projects/prosemirror/) |  |
| [Yjs — 让任何编辑器都能接的协同编辑内核](/study/projects/yjs/) |  |
...
| [LibreChat — 让一份聊天 UI 同时连 OpenAI / Anthropic / Google / 本地模型，对话留在自己的服务器](/study/projects/librechat/) |  |
...
| [SortableJS — 一行代码让任何列表能用手拖排序](/study/projects/sortablejs/) |  |
...
| `electron-builder` | [electron-builder — Electron 打包发布事实标准](/study/projects/electron-builder/) |
...
| `freecad` | [FreeCAD — 参数化 CAD](/study/projects/freecad/) |
...
| `gimp` | [GIMP — GNU 图像处理程序](/study/projects/gimp/) |
...
| `jupyterlab` | [JupyterLab — 下一代 Jupyter IDE](/study/projects/jupyterlab/) |
...
| `nodegui` | [nodegui — 用 Node.js 写原生桌面窗口](/study/projects/nodegui/) |
...
| `optuna` | [Optuna — 超参搜索框架](/study/projects/optuna/) |
...
| `starrocks` | [StarRocks — MPP 列存数据库](/study/projects/starrocks/) |
...
| `zeppelin` | [Apache Zeppelin — JVM 多语言笔记本](/study/projects/zeppelin/) |
...
| `code-server` | [code-server — 浏览器里的 VS Code](/study/projects/code-server/) | 其他 |
...
| `electron-builder` | [electron-builder — Electron 打包发布事实标准](/study/projects/electron-builder/) | 其他 |
...
| `freecad` | [FreeCAD — 参数化 CAD](/study/projects/freecad/) | 其他 |
...
| `gimp` | [GIMP — GNU 图像处理程序](/study/projects/gimp/) | 其他 |
...
| `jitsi-meet` | [Jitsi Meet — 开源视频会议的自托管套件](/study/projects/jitsi-meet/) | 其他 |
...
| `jupyterlab` | [JupyterLab — 下一代 Jupyter IDE](/study/projects/jupyterlab/) | 其他 |
...
| `melonjs` | [melonJS — 轻量 JS 2D 游戏引擎](/study/projects/melonjs/) | 其他 |
...
| `nodegui` | [nodegui — 用 Node.js 写原生桌面窗口](/study/projects/nodegui/) | 其他 |
...
| `optuna` | [Optuna — 超参搜索框架](/study/projects/optuna/) | 其他 |
...
| `postal` | [Postal — 自托管的 Mailgun / SendGrid 替代](/study/projects/postal/) | 其他 |
...
| `raylib` | [raylib — 极简 C 游戏库](/study/projects/raylib/) | 其他 |
...
| `starrocks` | [StarRocks — MPP 列存数据库](/study/projects/starrocks/) | 其他 |
...
| `stern` | [stern — 多 pod 多 container 日志聚合 tail](/study/projects/stern/) | 其他 |
...
| `zeppelin` | [Apache Zeppelin — JVM 多语言笔记本](/study/projects/zeppelin/) | 其他 |
