...
<div class="jx-proof__metric"><strong>2050</strong><span>篇项目与论文笔记</span></div>
<div class="jx-proof__metric"><strong>87</strong><span>个项目已对齐标杆标准</span></div>
...
<div><dt>Limitations / 局限</dt><dd class="jx-proof__limitation">大规模覆盖不等于每篇同等成熟；AI 初稿可能误读，关键结论应回到引用来源核查。</dd></div>
  ...
  <p class="study-muted"><strong>当前规模：</strong>1083 篇论文 + 967 个项目 = 2050 篇笔记。当前状态来自 <code>data/site-state.json</code>；数量已移出首屏，只作为覆盖面证据。</p>
