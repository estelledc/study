...
- 学习 [Claude Code Agents 机制](../learnings/claude-code-agents.md) 后，Agency Agents 展示了如何系统化地管理和复用 Agent 定义
- 与 [Prompt Engineering 最佳实践](../learnings/prompt-engineering.md) 互补：Agency Agents 本质上是经过工程化封装的、可复用的高级提示词模板集合
- 了解 [MCP 协议](../learnings/mcp-protocol.md) 后，可结合 Agency Agents 中的 MCP Builder Agent 来构建自定义工具服务器
