...
- 为什么 [[tidb]] 的 [[tikv]]、[[cockroachdb]] 早期版本、Kafka Streams、[[flink-2015]] 状态后端都不约而同选了它——存储引擎这一层很难重新写一遍
...
- **2006 年**：Google [[bigtable-2006]] 论文用了 SSTable + Compaction，工业首例
...
- [[bigtable-2006]] —— LSM 工业化的起点
- [[flink-2015]] —— 状态后端跑在 RocksDB 上
