...
GitHub 2.4k 星，C 写成，GPLv2+ 协议。**核心配置文件 `kamailio.cfg` 用一种 C 风格 DSL 写路由逻辑**——类似 nginx 的 location 块，但流过来的是 SIP 信令而不是 HTTP。
...
- **2008 年**：OpenSER 和 SER 合并，改名 Kamailio——巴西土著词意为"喜悦的呼喊"
- **现在**：GitHub 2.4k 星，约 600 名贡献者，每年发两个主版本
