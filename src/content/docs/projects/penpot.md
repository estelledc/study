...
- 为什么 48k stars 的项目能保持小团队节奏——共享类型 schema 让前后端少写一倍 DTO
...
2. **自托管硬件被低估**：Postgres + Redis + JVM + node exporter 起步至少 4G 内存，1G 小机器跑不动
...
48k stars 的成长全靠"反 SaaS 锁定"叙事和持续小步快跑的工程节奏。
