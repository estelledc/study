...
- **2023 年**：LLaMA 开源后，社区需要一套能快速复现实验的微调脚手架，axolotl 因为 YAML 配方简单开始流行。
- **2024 年**：QLoRA、DPO、ORPO 等训练路线集中爆发，axolotl 把这些方法收进同一套配置入口。
- **2025 年以后**：多卡、长上下文、偏好优化和推理前 merge 成为日常需求，axolotl 的定位从个人脚本变成团队训练配方库。
