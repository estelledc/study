...
- 远程课堂或在线面试里，两端都在酒店/校园网后面，直连候选全失败
...
- [[mediasoup]] —— SFU 负责多人媒体转发，coturn 负责连不上公网地址时兜底
- [[jitsi-meet]] —— 典型自建视频会议入口，生产部署常要配 coturn
- [[ice-rfc-5245]] —— ICE 决定先试直连、再试 STUN 反射、最后才走 TURN 中继
