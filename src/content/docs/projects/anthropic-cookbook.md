...
仓库地址：`github.com/anthropics/anthropic-cookbook`，**Apache 2.0** 协议，可商用、可改、可贴自己代码里。
...
- 仓库本身：[anthropics/anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
