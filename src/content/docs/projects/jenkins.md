...
- **CI/CD 的工程化雏形**——2004 年没有 GitHub Actions、没有 GitLab CI，Jenkins 几乎是企业自动化的唯一选择，今天的 CI 概念多半是它带出来的
- **插件即生态**——2000+ 插件，不管你用什么构建工具/版本控制/部署目标，都能找到一个插件粘上
- **Pipeline as Code**——把流水线写成 Jenkinsfile 进 Git，CI 流程也能 PR review，2016 年这个范式被 Jenkins 推上主流
- **企业仍然在跑**——虽然新项目越来越选 GitHub Actions，存量上跑 Jenkins 的大型企业、银行、车厂依然海量，懂 Jenkins 是 DevOps 工程师的硬通货
...
- **2024 年**：依然占企业 CI 服务器市场份额第一（虽然份额持续被 GitHub Actions 蚕食），插件生态规模无人能敌。
