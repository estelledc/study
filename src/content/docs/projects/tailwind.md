...
- 为什么 v4（2024）启动比 v3 快 10 倍——整个引擎用 Rust 重写
...
- **2017 年**：Adam Wathan 写博客 "CSS Utility Classes and Separation of Concerns" 扭转行业偏见，发布 Tailwind v1
- **2020 年 v2**：JIT 实验性引入
- **2021 年 v3**：JIT 成默认，支持任意值 `top-[117px]`
- **2024 年 v4**：Rust 重写编译器，build 速度 5-10x，配置文件可以删除
