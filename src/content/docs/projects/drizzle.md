...
4. **Studio GUI 是付费 + Cloud-hosted**：Drizzle Studio（可视化看表 / 跑 query 的 GUI）是 Drizzle 团队的商业化方向之一——付费 + 云端版本。本地版功能有限。Prisma Studio 是免费 + 本地，差异很大。
...
- 官方文档：[orm.drizzle.team](https://orm.drizzle.team/)（按 driver 分章节，例子多）
- 对比文章：[Drizzle vs Prisma](https://orm.drizzle.team/docs/comparison)（官方视角，有偏向但材料齐）
