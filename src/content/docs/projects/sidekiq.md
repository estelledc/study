...
4. **Redis 挂了任务全飞**：默认 Redis 配置不持久化，重启就空。生产环境必须开 AOF 或 RDB，并且备份。
...
- Mike Perham 博客：[The Brutal Lifecycle of JavaScript Frameworks 我编错了，是 Sidekiq economics](https://www.mikeperham.com/)（讲商业模型）
