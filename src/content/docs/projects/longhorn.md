...
Longhorn 是一个**专门给 Kubernetes 用的分布式块存储系统**。Rancher 团队约 2014–2015 年开始做，**2017 年开源到 GitHub**，**2019-10 进入 CNCF Sandbox**，**2021-11 升为 Incubating**（不是 2024）。
...
- **2014–2015 年**：Rancher 侧启动 Longhorn（Sheng Yang 等后续主导），最初是给容器加持久卷的内部方向
- **2017 年**：开源到 GitHub（仓库约 2017-04 创建），仍深度绑定 Rancher 生态
- **2019-10**：捐给 CNCF，进入 Sandbox
- **2020 年**：SUSE 收购 Rancher，Longhorn 跟过去
- **2021-11**：CNCF 升为 Incubating
- **2023 年起**：v2 引擎基于 SPDK 推进，解决 v1 iSCSI 路径性能瓶颈
