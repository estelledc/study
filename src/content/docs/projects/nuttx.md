...
- [FreeRTOS](/projects/freertos) — 最流行的开源 RTOS，API 更简单但不走 POSIX 路线，适合对比学习两种设计哲学
- [Zephyr](/projects/zephyr) — Linux 基金会支持的现代 RTOS，也在追赶 POSIX 兼容，生态和 NuttX 有竞争关系
- [RT-Thread](/projects/rt-thread) — 国产开源 RTOS，同样提供类 POSIX 接口和丰富的软件包生态
