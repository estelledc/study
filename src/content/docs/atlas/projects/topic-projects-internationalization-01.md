---
title: "i18n 国际化 · 项目 · 第 1 组"
description: "5 条 i18n 国际化 Atlas 分块"
sidebar:
  hidden: true
---
...
| 项目 | Slug | 难度 | 可信状态 | 简介 |
|---|---|---|---|---|
| [i18next — 让一份 JS 代码同时讲几十种语言](/study/projects/i18next/) | `i18next` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
