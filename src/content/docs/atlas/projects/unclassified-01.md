...
| 项目 | Slug | 难度 | 可信状态 | 简介 |
|---|---|---|---|---|
| [Aubio — 用音频信号提取节奏与音高](/study/projects/aubio/) | `aubio` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [BentoML — 模型打包部署](/study/projects/bentoml/) | `bentoml` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [Captum — 给 PyTorch 模型装上 X 光机](/study/projects/captum/) | `captum` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
...
| [Temporal — 持久化工作流引擎](/study/projects/temporal/) | `temporal` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [Triton Inference Server — NVIDIA 多框架推理服务化标杆](/study/projects/triton-inference-server/) | `triton-inference-server` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [Vega-Lite — 高层声明式可视化语法](/study/projects/vega-lite/) | `vega-lite` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [Volta — cd 进项目就自动换 Node 版本的工具链管理器](/study/projects/volta/) | `volta` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [Weights & Biases — 几行 init 把指标系统代码自动入库](/study/projects/wandb/) | `wandb` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [Apache ZooKeeper — 给一群机器装一个共同的小脑](/study/projects/zookeeper/) | `zookeeper` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
