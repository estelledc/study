...
| [p-retry — 给会失败的异步函数做指数退避重试](/study/projects/p-retry/) | `p-retry` | beginner | UNVERIFIED | 固定 8 |
| [p-timeout — 给已经开始的 Promise 加一只计时器](/study/projects/p-timeout/) | `p-timeout` | beginner | UNVERIFIED | 固定 7 |
