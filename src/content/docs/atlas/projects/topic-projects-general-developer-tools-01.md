...
| [chokidar — 把 fs.watch 收成可组合的文件事件](/study/projects/chokidar/) | `chokidar` | 中级 | UNVERIFIED | 介绍 chokidar 5 |
...
| [nodemon — 文件一变就重启子进程的开发监视器](/study/projects/nodemon/) | `nodemon` | 中级 | UNVERIFIED | 介绍 nodemon 3 |
