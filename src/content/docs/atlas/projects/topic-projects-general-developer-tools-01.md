...
| [defu — 最左优先的递归默认值合并](/study/projects/defu/) | `defu` | beginner | UNVERIFIED | 从空对象 reduce，nullish 跳过，数组按用户项在前拼接 |
...
| [rfdc — 先造拷贝函数再走路的深克隆](/study/projects/rfdc/) | `rfdc` | beginner | UNVERIFIED | 工厂返回 clone，默认不跟环也不抄原型，Date/Map/Set 走精确 constructor |
