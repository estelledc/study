...
| [ksuid — 把秒级时间戳放进 20 字节、27 位 base62 的可排序 ID](/study/projects/ksuid/) | `ksuid` | beginner | UNVERIFIED | 介绍 novemberborn/ksuid 3 |
...
| [typeid-js — 用前缀 + UUIDv7 suffix 做出可排序、可辨类型的 ID](/study/projects/typeid-js/) | `typeid-js` | beginner | UNVERIFIED | 介绍 typeid-js 1 |
