...
| [del — 先 glob 再删的 Node 清理库](/study/projects/del/) | `del` | intermediate | UNVERIFIED | 固定 8 |
...
| [rimraf — 跨平台的 Node `rm -rf`](/study/projects/rimraf/) | `rimraf` | intermediate | UNVERIFIED | 固定 6 |
