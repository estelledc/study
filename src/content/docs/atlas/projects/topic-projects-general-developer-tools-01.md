...
| [change-case — 用 Unicode 切词再映射到十一种写法](/study/projects/change-case/) | `change-case` | beginner | UNVERIFIED | 先用 Unicode 正则切词，再换 delimiter / locale |
...
| [scule — 先切词再拼大小写的 TypeScript 字符串工具](/study/projects/scule/) | `scule` | beginner | UNVERIFIED | 默认按 - _ / |
