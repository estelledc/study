...
| [Cuid2 — 把时间、计数器和主机指纹哈希成不可猜的短 ID](/study/projects/cuid2/) | `cuid2` | intermediate | UNVERIFIED | 固定 3 |
...
| [ULID — 时间在前、Crockford Base32 编码的可排序 128-bit ID](/study/projects/ulid/) | `ulid` | intermediate | UNVERIFIED | 固定 3 |
