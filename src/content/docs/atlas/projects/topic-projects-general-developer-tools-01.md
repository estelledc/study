...
| [CSON — 把 CoffeeScript 对象记号包成文件与 CLI 的高层包装](/study/projects/cson/) | `cson` | beginner | UNVERIFIED | 介绍 cson 8 |
...
| [Hjson — 给 JSON 加注释、无引号键和可省略逗号的人类配置格式](/study/projects/hjson/) | `hjson` | beginner | UNVERIFIED | 介绍 hjson 3 |
