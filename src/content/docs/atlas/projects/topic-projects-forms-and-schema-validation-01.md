...
description: "6 条 表单 / Schema 校验 Atlas 分块"
sidebar:
  hidden: true
---
...
| 项目 | Slug | 难度 | 可信状态 | 简介 |
|---|---|---|---|---|
| [ArkType — schema 长得像 TypeScript 类型本身](/study/projects/arktype/) | `arktype` | intermediate | UNVERIFIED | 用接近 TypeScript 的 definition 生成节点图，再遍历数据做校验与转换 |
...
| [Typia — 从 TypeScript 类型编译出校验函数](/study/projects/typia/) | `typia` | intermediate | UNVERIFIED | 编译期把 TypeScript 类型变成专用校验函数，运行时不再解释一份 schema |
