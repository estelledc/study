...
| [ripgrep — Rust 写的现代 grep](/study/projects/ripgrep/) | `ripgrep` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
...
| [zoxide — 学会你常去哪的智能 cd](/study/projects/zoxide/) | `zoxide` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [zsh — 比 bash 更聪明的兼容派 shell](/study/projects/zsh/) | `zsh` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
