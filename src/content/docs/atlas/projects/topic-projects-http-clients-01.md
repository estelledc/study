...
description: "7 条 HTTP 客户端 Atlas 分块"
sidebar:
  hidden: true
---
...
| [node-fetch — 把 WHATWG Fetch 接到 Node http](/study/projects/node-fetch/) | `node-fetch` | intermediate | UNVERIFIED | ESM userland Fetch：用 Node http/https 实现 WHATWG 外观，不自带 retry，也不走 undici |
| [ofetch — 以 Fetch 为底座的跨运行时请求包装](/study/projects/ofetch/) | `ofetch` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [Undici — Node.js 官方 HTTP 客户端与 Fetch 实现](/study/projects/undici/) | `undici` | intermediate | UNVERIFIED | Node |
