...
| [Qwik — 用 resume 代替 hydrate 的编译器 UI](/study/projects/qwik/) | `qwik` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
...
| [Stencil — 把 TSX 编成 Custom Element 的编译器](/study/projects/stencil/) | `stencil` | intermediate | UNVERIFIED | 把 TSX 编成 Custom Element 的编译器，产物可在任意框架里当 Web Component 用 |
