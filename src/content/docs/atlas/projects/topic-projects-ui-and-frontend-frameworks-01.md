...
| 项目 | Slug | 难度 | 可信状态 | 简介 |
|---|---|---|---|---|
| [cmdk — 用复合组件拼出来的命令菜单](/study/projects/cmdk/) | `cmdk` | 中级 | UNVERIFIED | React 命令菜单：子组件自己注册，过滤时仍留在 React 树，只从 DOM 卸下 |
| [jsPDF — 浏览器里直接生成 PDF](/study/projects/jspdf/) | `jspdf` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [kbar — 用 action 树驱动的命令栏](/study/projects/kbar/) | `kbar` | 中级 | UNVERIFIED | React 命令栏：action 对象进 store，空搜看根节点，输入后用 Fuse 搜整棵子孙树 |
