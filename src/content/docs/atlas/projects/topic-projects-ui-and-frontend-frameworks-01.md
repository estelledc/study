...
| 项目 | Slug | 难度 | 可信状态 | 简介 |
|---|---|---|---|---|
| [Alpine.js — 在 HTML 上长出一块本地响应式](/study/projects/alpinejs/) | `alpinejs` | intermediate | UNVERIFIED | 用 x-data 指令和 Vue reactivity 在 HTML 上挂本地响应式状态的 HTML-first 库 |
| [htmx — 用 HTML 属性发请求、换 DOM](/study/projects/htmx/) | `htmx` | intermediate | UNVERIFIED | 用 HTML 属性发出 XHR 并按固定 swap/status 规则替换 DOM 的 HTML-first 库 |
...
| [TimelineJS — 把 Google Sheet 一键变成新闻时间线](/study/projects/timelinejs/) | `timelinejs` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [vis-network — barnesHut 物理引擎驱动的网络图](/study/projects/vis-network/) | `vis-network` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [vis-timeline — 时间轴 / 日程 / 历史事件三合一组件](/study/projects/vis-timeline/) | `vis-timeline` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [Vue.js — 渐进式 UI 框架](/study/projects/vue/) | `vue` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
