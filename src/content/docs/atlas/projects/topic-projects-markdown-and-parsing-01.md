...
description: "6 条 Markdown / 解析 Atlas 分块"
sidebar:
  hidden: true
---
...
| [markdown-wasm — 把 md4c 封进 WASM 房间的 Markdown 渲染器](/study/projects/markdown-wasm/) | `markdown-wasm` | intermediate | UNVERIFIED | markdown-wasm 用一份共享 WASM 缓冲把 markdown 编译成 HTML |
| [marked — 用一堆正则把 markdown 变成 HTML 的轻量解析器](/study/projects/marked/) | `marked` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [micromark — 一个字一个字往前推的 CommonMark 状态机](/study/projects/micromark/) | `micromark` | intermediate | UNVERIFIED | micromark 用 construct 状态机发事件，再编译成默认消毒的 HTML |
