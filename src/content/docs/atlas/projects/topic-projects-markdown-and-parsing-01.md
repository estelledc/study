...
| 项目 | Slug | 难度 | 可信状态 | 简介 |
|---|---|---|---|---|
| [js-yaml — v5 把 load/dump 接到事件管线上](/study/projects/js-yaml/) | `js-yaml` | intermediate | UNVERIFIED | v5 仍叫 load/dump，内部已换成事件流再构造 JS |
...
| [yaml — 先留下 Document，再决定要不要变成 JS](/study/projects/yaml/) | `yaml` | intermediate | UNVERIFIED | 先收成可改的 Document，需要普通对象时再 toJS |
