...
| [remark-frontmatter — 只认 frontmatter 围栏，不解析里面的值](/study/projects/remark-frontmatter/) | `remark-frontmatter` | beginner | UNVERIFIED | 介绍 remark-frontmatter 如何把 YAML 与 TOML 围栏挂进 micromark 与 mdast，以及它为什么不把键值拆成对象 |
...
| [vfile-matter — 用正则取出 YAML 头并写入 file.data.matter](/study/projects/vfile-matter/) | `vfile-matter` | beginner | UNVERIFIED | 介绍 vfile-matter 如何用锚定正则取出 YAML 头并写入文件的 matter 字段，同时说明 strip 与 YAML 版本边界 |
