...
| 项目 | Slug | 难度 | 可信状态 | 简介 |
|---|---|---|---|---|
| [htmlparser2 — 用回调与启发式补洞的流式 HTML/XML 解析器](/study/projects/htmlparser2/) | `htmlparser2` | beginner | UNVERIFIED | 介绍 htmlparser2 如何用 Tokenizer、Parser 回调和 openImpliesClose 组织流式解析，并区分 DOM helper 与 WHATWG 树构建 |
...
| [parse5 — 按 WHATWG 插入模式建树的 HTML 解析器](/study/projects/parse5/) | `parse5` | beginner | UNVERIFIED | 介绍 parse5 如何用 Tokenizer、插入模式和 tree adapter 做出与浏览器同款的 HTML 文档树 |
