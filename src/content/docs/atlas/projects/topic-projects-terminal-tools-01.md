...
| 项目 | Slug | 难度 | 可信状态 | 简介 |
|---|---|---|---|---|
| [boxen — 给终端文本套边框的纯拼接库](/study/projects/boxen/) | `boxen` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
...
| [wrap-ansi — 按可见列宽给带 ANSI 的字符串换行](/study/projects/wrap-ansi/) | `wrap-ansi` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
