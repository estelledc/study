...
| [Farm — Rust 编译内核配 Vite 插件适配的打包器](/study/projects/farm/) | `farm` | intermediate | UNVERIFIED | 介绍 Farm 如何用 Rust 编译内核、先返回者 resolve 和 Vite 插件适配完成打包 |
...
| [Rsbuild — 把 Rspack 收成环境可拆的高层构建工具](/study/projects/rsbuild/) | `rsbuild` | intermediate | UNVERIFIED | 介绍 Rsbuild 如何用默认插件和环境拆分把 Rspack 收成高层构建工具 |
