...
| [mlly — 给 Node ESM 补齐 resolve、interop 和语法探测](/study/projects/mlly/) | `mlly` | intermediate | UNVERIFIED | 介绍 mlly 如何用同步 ESM resolve、interopDefault 和语法探测补齐 Node 模块工具 |
...
| [pkg-types — 给 package.json 和 tsconfig 一套可读可写的类型与查找](/study/projects/pkg-types/) | `pkg-types` | intermediate | UNVERIFIED | 介绍 pkg-types 如何查找、解析和写回 package |
