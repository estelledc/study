...
| [ESLint — 可插拔的 JS/TS 静态检查器](/study/projects/eslint/) | `eslint` | intermediate | UNVERIFIED | 固定版本只认 flat config |
...
| [Prettier — 把源码打成一份 doc IR 再打印](/study/projects/prettier/) | `prettier` | intermediate | UNVERIFIED | 固定版本的 format 主链是 parse → printAstToDoc → printDocToString |
