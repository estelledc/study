...
| 项目 | Slug | 难度 | 可信状态 | 简介 |
|---|---|---|---|---|
| [Babel — 插件走过 AST 的 JS 编译器](/study/projects/babel/) | `babel` | intermediate | UNVERIFIED | 8 |
...
| [Recast — 尽量复用原文的 JS AST 打印机](/study/projects/recast/) | `recast` | intermediate | UNVERIFIED | 默认 Esprima 解析 |
