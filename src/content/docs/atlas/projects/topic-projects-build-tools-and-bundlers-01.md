...
| [lilconfig — 零依赖的 cosmiconfig 子集](/study/projects/lilconfig/) | `lilconfig` | intermediate | UNVERIFIED | 按工具名搜索 rc / package |
...
| [unconfig — 给工具作者的多源配置加载器](/study/projects/unconfig/) | `unconfig` | intermediate | UNVERIFIED | 用 source 列表搜索并加载 TS/ESM/JSON 配置，可选 defu 合并 |
