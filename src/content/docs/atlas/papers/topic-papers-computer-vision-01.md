---
title: "计算机视觉 · 论文 · 第 1 组"
description: "11 条 计算机视觉 Atlas 分块"
sidebar:
  hidden: true
---
...
| [ResNet — 残差连接](/study/papers/resnet/) | `resnet` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [SAM — Segment Anything](/study/papers/sam/) | `sam` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
| [ViT — Vision Transformer](/study/papers/vit/) | `vit` | unknown | UNVERIFIED | 暂无独立描述；可先从标题与正文定位开始。 |
