---
title: 推荐队列
description: 按主题分组的 pillar 项目推荐——965 篇项目笔记的导航起点
sidebar:
  order: 2
---

> 不是"读哪 20 个"的清单，是"先读哪 5 个就能撑起一个领域"的导航。
> 当前站点 965 篇项目笔记 + 1083 篇论文笔记，凑数没有意义，**取舍**才有。
...
- 项目全景（965 篇按主题分组、反向链接热度、消化状态）：[projects-atlas](/study/projects-atlas/)
- 论文全景（1083 篇按子领域、pillar 标记、未消化队列）：[papers-atlas](/study/papers-atlas/)
