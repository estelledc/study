...
LOCUS 允许一个**正在运行**的进程从节点 A 搬到节点 B，搬完继续跑。机制大致：
...
更狠的：LOCUS 允许 `fork()` 出来的子进程跑在**另一台节点**上。
...
- 论文 PDF（ACM）：[Walker et al. 1983 — The LOCUS Distributed Operating System](https://dl.acm.org/doi/10.1145/800216.806587)（SOSP-8 原文，14 页）
- 后续综述：Popek & Walker, _The LOCUS Distributed System Architecture_（MIT Press 1985，整本书）
