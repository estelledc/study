...
- 为什么 RAPPOR 要在客户端做随机响应再让服务端解码——这正是 Duchi 框架里最优机制的工程实现
- 为什么隐私预算 epsilon 越小，你需要**指数级更多**的用户才能得到同样精度的统计结论
...
假设你想估计公司员工平均薪资（连续值），每人本地加拉普拉斯噪声再上报。Duchi 证明你需要大约 n 约等于 1/(delta^2 * epsilon^2) 个人才能把误差控制在 delta 以内。如果 epsilon = 1（强隐私），要达到 5% 误差需要约 400 人；中心化模型在同样 400 人时误差已经是 5%/epsilon，也就是说中心化天然好 1/epsilon 倍。
...
- 需要严格隐私合规的产品——GDPR / CCPA 下用 LDP 可免除很多数据保护义务，因为服务器从未持有个人数据
