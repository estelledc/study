...
- 为什么 Xilinx 2011 年花 5000 万美元收一家小公司 AutoESL，结果做出了 Vivado HLS
- 为什么"用 Python/C 写算子跑在 FPGA"是真的（背后是 HLS）而不是噱头
- 为什么写硬件的生产力突然提了 5 倍，但写出来的电路又常常比手写的慢一倍
...
3. **HLS RTL 比手写慢 1.5-2 倍**：哪怕调好 #pragma，自动生成的 Verilog 在面积 / 频率上仍输给 RTL 工程师手写，关键路径还是要懂 RTL 才能调。
...
1. **抽象层级提升的代价**：从 RTL 升到 C，开发效率 5x 但电路质量降 1.5-2x；这是工程史的常见 tradeoff
