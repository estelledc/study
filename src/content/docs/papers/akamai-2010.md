...
这套架构是 Cloudflare、Fastly、AWS CloudFront / Global Accelerator 至今仍在抄的模板。
...
读这段你能感受到 Google 同时代论文（[[bigtable-2006]] / [[chubby]]）的同款味道——大规模系统的容错都是"假设组件不可靠，靠副本和共识修"。
...
- **2010 年之后**：Cloudflare 2010 上线 Argo Smart Routing 直接对标 SureRoute；AWS 2018 推 Global Accelerator 抄 IP 应用加速；Fastly 卖 Edge Compute——CDN 平台化路线全部沿用本文思路。
