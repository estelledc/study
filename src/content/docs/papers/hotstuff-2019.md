...
- [[tendermint-2016]] —— 思想前身，先提出 lock-on-PoLC

## 关联

- [[pbft-1999]] —— PBFT 是 HotStuff 优化的对象，理解它才知道线性化的价值
- [[tendermint-2016]] —— Tendermint 的两阶段提交是 HotStuff 三阶段的精神原型
- [[paxos-1998]] —— Paxos 处理崩溃故障，HotStuff 处理恶意故障；前者是后者的"非拜占庭版本"
- [[raft]] —— Raft 的清晰度是 HotStuff 的设计参考——leader-based + 简化 view-change
- [[move-language]] —— Diem/Aptos 上跑的智能合约语言，下面共识就是 HotStuff
- [[byzantine-generals-1982]] —— Lamport 1982 的拜占庭将军问题是所有 BFT 协议的共同源头
