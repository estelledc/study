...
- [[gptq-2023]] —— 同期对手，反向重建路线
- [[smoothquant-2023]] —— 同 HAN Lab，把激活异常吸到权重上的兄弟工作
- [[llm-int8-2022]] —— 更早的混合精度路线
...
- [[gptq-2023]] —— 同期对手，反向重建 vs 前向 grid search 的两条路线对比
- [[smoothquant-2023]] —— 同 HAN Lab 兄弟工作，为 W8A8 而生
