...
一句话：**Ethane 是企业网里『集中控制 + 可编程策略』这条路的早期工业验证**——后来被称作 SDN 的精神前身之一。
...
- **2006 年前后**：Casado 此前在 Lawrence Livermore 做 DoD / 情报社区相关的网络安全，这段经历启发他去 Stanford 读博，研究『怎么让企业网管得住』。他发现传统方案（VLAN + ACL + 防火墙）配置量随主机数指数增长，运维人均维护几千条规则，错误率极高。
