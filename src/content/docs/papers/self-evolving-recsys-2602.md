...
<!-- 当前已知反向引用：self-evolving-agents-survey, misevolution-2509 -->
<!-- 反向链接刷新由 finalize-round 自动触发 -->
<!-- inner / outer loop 双层是该论文最核心贡献 -->
<!-- YouTube production launch 是工业级 self-evolving 的首批实证 -->
<!-- proxy gaming 是 inner loop 的内生风险 -->
<!-- 工程基建（CI/CD / quota / sandbox）和 agent 算法同等重要 -->
<!-- 论文 LLM 基座是 Gemini 系列 -->
<!-- north star metric 在视频域指 long-term engagement -->
<!-- 这套系统门槛是大流量 + 完整 ML pipeline -->
<!-- inner loop 用历史数据回放，outer loop 用真实流量 A/B -->
<!-- agent 提的代码进 production 前要走完整 sanity check -->
<!-- 论文报告"既加速开发又提升模型性能"二者兼得 -->
