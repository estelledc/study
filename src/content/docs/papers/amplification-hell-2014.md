...
这篇论文给整个 2010 年代后半段 DDoS 浪潮做了体检报告。它解释了为什么 2013 年 Spamhaus 被打 300 Gbps、2014 年 OVH 被打 400 Gbps、2016 年 Dyn 被打到 1 Tbps——不是攻击者突然有了核武器，而是互联网上摆着上百万台默认开放的 NTP / DNS / SSDP 服务器，谁都能征用。
...
- **2016 年 10 月**：Mirai 僵尸网络打 Dyn DNS——叠加 IoT 数量+反射放大，首破 Tbps。
- **2018 年 2 月**：GitHub 被 1.35 Tbps memcached 反射打中——本文方法论换协议再现。

整个 2010 年代 DDoS 量级从十 Gbps 到 Tbps 三个数量级的跃迁，主因不是带宽变便宜，是**没人花一年去把"开放的反射器"扫出来登记**——这篇论文就是那张登记表。
