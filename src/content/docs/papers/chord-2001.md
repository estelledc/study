...
假设圆环 m=6（编号 0 到 63），有 4 台机器：N1、N8、N14、N32。
现在 N1 想查 key=54 在谁那里。
...
1. N1 看：54 在我的指针表里"最远但不超过 54"的是 N32（指针 i=6）
2. N1 把请求转给 N32
3. N32 看：54 距离我 22，我的指针表里最远不超过 54 的是 N42（假设有）
4. 一路逼近，最多 log(64) = 6 跳就到 successor(54)
