...
2. **Heun 在低步数时反而拉胯**。每步多一次前向，步数 < 20 时一阶 Euler 反而总 NFE 更少。EDM 默认 35 步是甜点，别盲目套用到 10 步场景——那是 [[consistency-models-2023]] 的地盘。
...
- 极低步数采样（1-4 步）——用 [[consistency-models-2023]] / Rectified Flow / DMD 蒸馏，EDM 默认 35 步太多
...
- [[consistency-models-2023]] —— 在 EDM 框架上做蒸馏，把 35 步压到 1-4 步
