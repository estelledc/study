...
- 为什么垃圾回收（GC）这件事我们认为理所当然——它约在 1959 年随早期 LISP 实现落地，后写入 1962 年的 LISP 1.5 手册
...
- **1959 年前后**：为了 cons 单元自动回收，Edwards 等实现了**垃圾回收**（历史上最早的自动 GC 之一）；机制后来写进 1962 年 LISP 1.5 Programmer's Manual
