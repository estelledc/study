...
- [[attention]] —— Attention Is All You Need —— Transformer 架构原始论文，BERT 的 backbone 来源
- [[llama]] —— LLaMA 开源大模型系列，与 BERT 是 NLP 路线分化的两端
- [[t5]] —— T5 Text-to-Text Transfer Transformer，把所有 NLP 任务统一成 text-to-text
