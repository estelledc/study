...
- 为什么 Facebook 2021 年宕机 6 小时，员工连办公门禁都刷不开——骨干网故障触发 BGP 撤回权威 DNS 路由后，全世界解析不到他们的域名
...
1. **TTL 配错**：TTL 太高，切换 IP 等一天；TTL 太低，权威一抖缓存立刻失效，查询洪峰打回权威。Facebook 2021 宕机根因是骨干网/BGP 撤回了权威 DNS 前缀（不是低 TTL 本身），但短 TTL 让全球缓存几分钟内清空，故障瞬间被放大。
