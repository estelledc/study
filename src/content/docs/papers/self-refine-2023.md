...
- 为什么 2023 年开始有了"agent loop"这个词——Self-Refine 是其中**最小可行版**
...
论文给出的数字也很直接：在 GPT-4 上，7 个任务平均**绝对提升约 20 个百分点**，包括对话生成、代码可读性、代码优化、数学推理、情感反转、缩略语生成、约束生成——任务跨度很大但都吃这套。
...
- **2023 年 6 月**：Reflexion 加了**长期记忆**——把过往失败的反馈存下来给下次用

回头看，Self-Refine 是 2023 年 LLM agent 风潮里**架构最简、影响最深**的一篇之一。后来所有"loop 类" agent 都能在它身上找到原型。
