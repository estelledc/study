...
这是 Anki 23.10+（2023 年 10 月起）默认调度器，背后有 4000 万张卡每天在跑。
...
2. **遗忘曲线改成 power law**：R(t, S) = (1 + t/(9S))^-1。类比：S 越大越不易掉血，但时间 t 一过仍会慢慢松动；不是 1885 年那种"e^(-t/S) 指数掉血"，是慢得多的双曲线衰减。
...
- **2023 年 10 月**：FSRS-5（17 weights）成为 Anki 默认调度器，4000 万张卡每天在跑
