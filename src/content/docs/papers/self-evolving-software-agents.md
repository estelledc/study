...
<!-- BDI 是 1987 Bratman 的哲学框架，2026 由 LLM 复活 -->
<!-- behavioral inheritance 是该论文的核心 open problem -->
<!-- multi-agent 协调演化也尚未解决 -->
<!-- plan library merging / dedup 是另一个 open subproblem -->
<!-- LLM 生成代码的安全性需要 sandbox + 静态分析配合 -->
<!-- 论文实验跑在多 agent 环境，证明 desire / reasoning / code 同时演化可行 -->
<!-- 1987 Bratman → 1995 Rao&Georgeff → 2000s JADE → 2026 BDI-LLM -->
<!-- 关注作者 Robol & Giorgini 的后续工作可能在 multi-agent coordinator 方向 -->
<!-- 整篇笔记重点：把"骨架 vs 肌肉"的隐喻贯穿全文 -->
