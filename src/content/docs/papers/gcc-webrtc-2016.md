...
技术上，GCC 属于 AIMD（Additive Increase Multiplicative Decrease）家族的变体：网络空闲时加法增速，网络过载时乘法降速。但与经典 TCP AIMD 不同，GCC 的触发信号不是丢包，而是单向延迟梯度——更灵敏，也更适合实时媒体。
...
- 为什么用浏览器打 Google Meet / 飞书会议 / 腾讯会议时，网络变差画面会降清晰度而不是直接卡住——底层就是 GCC 在自动降码率
- 为什么 WebRTC 能在 UDP 上跑实时视频却不把同一 Wi-Fi 下别人的网也搞崩——GCC 保证了 TCP-friendly
