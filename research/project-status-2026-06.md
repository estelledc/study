...
description: study 站双千推进、专题闭环、流水线状态与部署后快照
日期: 2026-06-06
状态: snapshot
---
...
**study 站已写 1704 篇（papers 908 + projects 796），双千目标完成 85.2%（差 296）；视频论文 65/65、媒体项目 50/50、阅读站 3 hub 已闭环，auto-push v3 因治理期 `STOP_SIGNAL` 暂停；已部署 live [https://estelledc.github.io/study/](https://estelledc.github.io/study/)（commit `0539f36c`）。**
...
| 维度 | 已写 | 目标 | 完成率 | 缺口 |
|---|---:|---:|---:|---:|
| 论文 papers | **908** | 1,000 | 90.8% | 92 |
| 项目 projects | **796** | 1,000 | 79.6% | 204 |
| **合计** | **1,704** | 2,000 | **85.2%** | 296 |
...
1. ~~**部署**~~：已上线 [estelledc.github.io/study](https://estelledc.github.io/study/)（`0539f36c`）；后续 push 仍走 GitHub Pages CI
