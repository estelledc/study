...
| grbl | grbl | 6.4k | Arduino UNO 上跑的 G-code 解释器，~30 年的 CNC 控制鼻祖，500 行运动规划核心 | https://github.com/gnea/grbl |
| linuxcnc | LinuxCNC | 2k | RTLinux 实时内核上的 CNC 机床控制系统，HAL + 实时步进 + GUI 一体 | https://github.com/LinuxCNC/linuxcnc |
