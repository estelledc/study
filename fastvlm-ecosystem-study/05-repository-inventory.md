...
- 本地位置：`explorations/research/repos/<id>/`
- remote：`origin` 指向个人 fork，`upstream` 指向源仓库
- 父仓状态：所有源码目录由 `.gitignore` 的 `explorations/research/repos/*/` 忽略
...
git clone --depth=1 --filter=blob:none --sparse \
  ...
  explorations/research/repos/fastvlm

git -C explorations/research/repos/fastvlm remote add upstream \
  https://github.com/apple/ml-fastvlm.git

git -C explorations/research/repos/fastvlm sparse-checkout set \
