...
- acceptance checks：
  ...
  - `git diff --check`：通过。
  - `STUDY_CHANGED_FROM=2b64a3ebffee19b72d570bfe70b8c0547069ae16 npm run verify:ci`：规范 Node 22.23.1 / npm 11.17.0 下，除本机首次缺 Playwright 浏览器外全绿；安装 Chromium 后 23 个 a11y 测试通过。
...
- 下一条命令：在 https://github.com/estelledc/study/pull/303 做 review；未授权前不要 merge。
- superseded_by：`none`
