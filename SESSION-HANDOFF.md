...
- activated_by：`explicit-user-parallel-writer-gj-20260827`。
- detector fingerprint：指定双子在项目目录中不存在；本轮新建并绑定可达 revision。
- external delta 计数：授权范围内的 push + 1 个 PR；未 merge / 未 deploy。
- 已完成切片：
