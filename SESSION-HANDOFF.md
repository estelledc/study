...
- status：writer epoch `complete`；分支已 push，PR #281 待 review。merge / deploy 未授权。
...
- acceptance checks：
  ...
  - `git diff --check`：通过。
  - `STUDY_CHANGED_FROM=96da2ee8c00f7ff392b0e10e30233fe07158132b npm run verify:ci`：规范 Node 22.23.1 / npm 11.17.0 下全绿，含 23 Playwright a11y 测试、2292 HTML、2291 sitemap URLs。
...
- 下一次 wake 条件：owner review https://github.com/estelledc/study/pull/281 ，或另行授权 merge。
- 下一条命令：在 https://github.com/estelledc/study/pull/281 做 review；未授权前不要 merge。
- superseded_by：`none`
