...
- activated_by：`explicit-user-parallel-writer-hr-2026-08-27`。
- detector fingerprint：两页缺 `pinned_revision` / `evidence_boundary` / `self_test`；开放与已合并 study PR 未占用这两个 slug。
