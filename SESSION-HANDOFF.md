...
- activated_by：`explicit-user-parallel-writer-gr-2026-08-27`。
- detector fingerprint：`shiki` 缺 `pinned_revision` / `evidence_boundary` / `self_test`；目录无 `lowlight.md`；用户指定目标对，不走 fallback。
