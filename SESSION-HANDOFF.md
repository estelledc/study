...
- activated_by：`explicit-user-parallel-writer-hj-2026-08-27`。
- detector fingerprint：目录与开放 PR 无 `cache-manager.md` / `quick-lru.md`；#260 占用 unstorage+lru-cache，#124 占用 keyv+node-cache，本轮按指令避开这四者。
